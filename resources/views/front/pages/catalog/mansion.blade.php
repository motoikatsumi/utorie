@extends('front.layout',['body_class' => 'secondpage navstate_show page-catalog catalog_form catalog_mansion_form'])
...
@section('append_head')
    ...
    <style>
      ...
      .secondpage .main_body.catalog_form .catalogform_mv {
        background-image: url(../images/catalog/mainmv2_pc.jpg);
      }

      @media (max-width: 768px){
        .secondpage .main_body.catalog_form .catalogform_mv {
          background-image: url(../images/catalog/mainmv2_sp.jpg);
        }      
      }      
...
@endsection
@section('content')
<main class="main_body p-catalog catalog_form catalog_mansion_form">
  <!-- Mainlayout -->
  <section class="mainlayout">
    <div class="catalogform_mv">
      <div class="container catalogform_mv-txt">
        ...
        <h2><img class="dispc" src="{{asset('images/catalog/maintit2pc.png')}}" alt="カンタン資料請求であなたの理想を叶える新築分譲マンションがすぐ見つかる！"><img class="dissp" src="{{asset('images/catalog/maintit2sp.png')}}" alt="カンタン資料請求であなたの理想を叶える新築分譲マンションがすぐ見つかる！"></h2>
        <div class="recommend">
