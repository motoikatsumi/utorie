                ...
                <div class="col-sm-12 col-md-6">
                    <form method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input required type="text" class="form-control" placeholder="" value="" name="name">
                        </div>
                        <div class="form-group">
                            <label for="">所在地</label>
                            <select required name="pref_id" class="form-control">
                        ...
                        <div class="form-group">
                            ...
                            <input required type="text" placeholder="" class="form-control" id="company_search" value="">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="" value="" name="access">
                        </div>
                        <div class="form-group">
                            <label for="">営業時間</label>
                            <input type="text" class="form-control" placeholder="" value="" name="hours">
                        </div>
                        <div class="form-group">
                            <label for="">定休日</label>
                            <input type="text" class="form-control" placeholder="" value="" name="holiday">
                        </div>
                        <div class="form-group">
                            <label for="">電話番号</label>
                            <input type="text" class="form-control" placeholder="" value="" name="tel" maxlength="14">
                        </div>
