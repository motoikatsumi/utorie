...
<head>
  ...
  <meta http-equiv="X-UA-Compatible" content="IE=9; IE=8; IE=7; IE=EDGE"/>    
    <title>一括資料請求完了｜utorie（ウトリエ）</title>
  ...
  <meta name="csrf-token" content="ZNqCUuLnGClNctRi1z2AXaDAxOz0vxMNeCLfQFbt">
...
<body class="secondpage navstate_show page-contact-thanks">  
<header class="Header">
...
</header><main class="main_body p-contact-thanks">
  <!-- BREADCRUMB -->
  <section class="breadcrumb">
    <div class="container">
      <ul>
        <li><a href="https://utorie.jp">TOP</a></li>
        <li><a href="https://utorie.jp/catalog">一括資料請求</a></li>
        <li>申し込み完了</li>
      </ul>
    </div>
  </section>
